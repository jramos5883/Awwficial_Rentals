    ...
    <main>
      <section className="grid grid-cols-1 justify-items-center tablet:grid-cols-2 p-2">
        <div className="flex flex-col justify-center items-center px-5 lapsm:max-w-lg laplg:max-w-xl">
          ...
          <p>Step into a world where every angle tells a story. Our 360-degree photo booth doesn't just capture moments; it creates narratives. With a spin and a snap, you're in the spotlight from all sides. It's photography reimagined, and you're the star of the show!</p>
        </div>
      ...
      <section className="grid grid-cols-1 justify-items-center tablet:grid-cols-2 p-2">
        ...
        <img className="block w-full"  src="https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="" />
        <div className="flex flex-col justify-center items-center px-5 lapsm:max-w-lg laplg:max-w-xl">
          <h2 className="text-center"> Turn Down For What?!
          </h2>
          <p>Our 360-degree photo booth is the ultimate crowd-pleaser. Elevate the fun, capture every angle, and create unforgettable memories. Whether it's a wedding, corporate gala, or birthday bash, our photo booth adds a unique touch of excitement!</p>
        </div>
